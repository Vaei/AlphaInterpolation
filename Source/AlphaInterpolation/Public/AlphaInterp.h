...
struct ALPHAINTERPOLATION_API FInterpMapRange
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ALPHAINTERPOLATION_API FInterpClampRange
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ALPHAINTERPOLATION_API FInterpValue
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ALPHAINTERPOLATION_API FInterpParams
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ALPHAINTERPOLATION_API FInterpState
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ALPHAINTERPOLATION_API FAlphaInterp
{
	GENERATED_BODY()
